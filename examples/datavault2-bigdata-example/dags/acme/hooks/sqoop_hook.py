...
class SqoopHook(BaseHook):
    ...
    def _import_cmd(self, target_dir, append, file_type, split_by, direct,
                    driver, extra_import_options, out_dir):
    ...
    def import_table(self, table, target_dir=None, append=False, file_type="text",
                     ...
                     driver=None, extra_import_options=None, out_dir=None):
        """
    ...
    def copy_file(self, local_file, remote_file):
        ...
        cmd = ['hdfs', 'dfs', '-mkdir', '-p', remote_dir]
        self.Popen(cmd)

        cmd = ['hdfs', 'dfs', '-copyFromLocal', '-f', local_file, remote_file]
        self.Popen(cmd)
