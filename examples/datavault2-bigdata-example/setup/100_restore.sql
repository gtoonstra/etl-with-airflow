...
DROP DATABASE IF EXISTS dvdrentals;
...
ALTER TYPE public.mpaa_rating OWNER TO db_owner;
...
ALTER DOMAIN public.year OWNER TO db_owner;
...
ALTER FUNCTION public._group_concat(text, text) OWNER TO db_owner;
...
ALTER FUNCTION public.last_day(timestamp without time zone) OWNER TO db_owner;
...
ALTER FUNCTION public.last_updated() OWNER TO db_owner;
...
ALTER TABLE public.customer_customer_id_seq OWNER TO db_owner;
...
ALTER TABLE public.customer OWNER TO db_owner;
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO db_owner;
...
ALTER AGGREGATE public.group_concat(text) OWNER TO db_owner;
...
ALTER TABLE public.actor_actor_id_seq OWNER TO db_owner;
...
ALTER TABLE public.actor OWNER TO db_owner;
...
ALTER TABLE public.category_category_id_seq OWNER TO db_owner;
...
ALTER TABLE public.category OWNER TO db_owner;
...
ALTER TABLE public.film_film_id_seq OWNER TO db_owner;
...
ALTER TABLE public.film OWNER TO db_owner;
...
ALTER TABLE public.film_actor OWNER TO db_owner;
...
ALTER TABLE public.film_category OWNER TO db_owner;
...
ALTER TABLE public.actor_info OWNER TO db_owner;
...
ALTER TABLE public.address_address_id_seq OWNER TO db_owner;
...
ALTER TABLE public.address OWNER TO db_owner;
...
ALTER TABLE public.city_city_id_seq OWNER TO db_owner;
...
ALTER TABLE public.city OWNER TO db_owner;
...
ALTER TABLE public.country_country_id_seq OWNER TO db_owner;
...
ALTER TABLE public.country OWNER TO db_owner;
...
ALTER TABLE public.customer_list OWNER TO db_owner;
...
ALTER TABLE public.film_list OWNER TO db_owner;
...
ALTER TABLE public.inventory_inventory_id_seq OWNER TO db_owner;
...
ALTER TABLE public.inventory OWNER TO db_owner;
...
ALTER TABLE public.language_language_id_seq OWNER TO db_owner;
...
ALTER TABLE public.language OWNER TO db_owner;
...
ALTER TABLE public.nicer_but_slower_film_list OWNER TO db_owner;
...
ALTER TABLE public.payment_payment_id_seq OWNER TO db_owner;
...
ALTER TABLE public.payment OWNER TO db_owner;
...
ALTER TABLE public.rental_rental_id_seq OWNER TO db_owner;
...
ALTER TABLE public.rental OWNER TO db_owner;
...
ALTER TABLE public.sales_by_film_category OWNER TO db_owner;
...
ALTER TABLE public.staff_staff_id_seq OWNER TO db_owner;
...
ALTER TABLE public.staff OWNER TO db_owner;
...
ALTER TABLE public.store_store_id_seq OWNER TO db_owner;
...
ALTER TABLE public.store OWNER TO db_owner;
...
ALTER TABLE public.sales_by_store OWNER TO db_owner;
...
ALTER TABLE public.staff_list OWNER TO db_owner;
...
\.
COPY actor (actor_id, first_name, last_name, last_update) FROM '/docker-entrypoint-initdb.d/data/2163.dat';
...
\.
COPY address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM '/docker-entrypoint-initdb.d/data/2171.dat';
...
\.
COPY category (category_id, name, last_update) FROM '/docker-entrypoint-initdb.d/data/2165.dat';
...
\.
COPY city (city_id, city, country_id, last_update) FROM '/docker-entrypoint-initdb.d/data/2173.dat';
...
\.
COPY country (country_id, country, last_update) FROM '/docker-entrypoint-initdb.d/data/2175.dat';
...
\.
COPY customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM '/docker-entrypoint-initdb.d/data/2177.dat';
...
\.
COPY film (film_id, title, description, release_year, language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM '/docker-entrypoint-initdb.d/data/2167.dat';
...
\.
COPY film_actor (actor_id, film_id, last_update) FROM '/docker-entrypoint-initdb.d/data/2168.dat';
...
\.
COPY film_category (film_id, category_id, last_update) FROM '/docker-entrypoint-initdb.d/data/2169.dat';
...
\.
COPY inventory (inventory_id, film_id, store_id, last_update) FROM '/docker-entrypoint-initdb.d/data/2179.dat';
...
\.
COPY language (language_id, name, last_update) FROM '/docker-entrypoint-initdb.d/data/2181.dat';
...
\.
COPY payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '/docker-entrypoint-initdb.d/data/2183.dat';
...
\.
COPY rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM '/docker-entrypoint-initdb.d/data/2185.dat';
...
\.
COPY staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM '/docker-entrypoint-initdb.d/data/2187.dat';
...
\.
COPY store (store_id, manager_staff_id, address_id, last_update) FROM '/docker-entrypoint-initdb.d/data/2189.dat';
...
ALTER FUNCTION public.inventory_in_stock(p_inventory_id integer) OWNER TO db_owner;
...
ALTER FUNCTION public.film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO db_owner;
...
ALTER FUNCTION public.film_not_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO db_owner;
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp without time zone) OWNER TO db_owner;
...
ALTER FUNCTION public.inventory_held_by_customer(p_inventory_id integer) OWNER TO db_owner;
